...
I won't retell all the silliness that [Microslop](https://www.windowscentral.com/artificial-intelligence/microslop-trends-on-social-media-backlash-to-microsofts-on-going-ai-obsession-continues) has been up to but instead dive straight into a solution: Installing some flavor of Linux and finally taking back control of your own PC. This post will be a little different than my usual fare which is very programming heavy, but being that most of the software I write runs on Linux systems, using one as my home machine has been a great chance to refine my skills _and_ make my personal machines more usable, and my experiences recently with _just how stable and reliable it has been_ have encouraged me to recommend it to others, even those who are non software engineers. I hope this post helps you make sense of the process of switching and encourage you to take the leap.

If you want to jump straight into the install steps [go to this section](#the-actual-install-steps) to skip all the extra context and history below. You'll need a running full desktop computer of some kind for running the ISO flashing software (Windows, MacOS, Linux, even Android are all fine), a 32gb drive (you can go smaller but 32gb is about the smallest you can buy nowadays, it needs to be as big as the ISO file you'll download), a spare drive to install Linux onto (or your main SSD if you're ready to irreversibly upgrade), and a spare hour or two.
