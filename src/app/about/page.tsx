                ...
                <article className="mb-32">
                    ...
                    <div className="max-w-2xl mx-auto text-center">
                        ...
                        <div className="flex justify-center space-x-4 mb-4">
                            ...
                            <a
                                href="https://bsky.app/profile/dashdashforce.dev"
                                target="_blank"
                                rel="noopener noreferrer"
                            >
                                <FaBluesky className="text-2xl text-gray-600 hover:text-gray-800" />
                            </a>
                        </div>
                        <p className="text-lg mb-8">
                            I am a software engineer living in Boulder Colorado, where I am
                            currently employed as a Java, Python, Javascript/React, SQL, and
                            Snowflake engineer. I also have experience using Go, Rust, C#,
                            Kubernetes, Docker, Postgres and other related technologies
                            building data intensive applications for a wide range of
                            industries including medical and cloud application data
                            management. I have a passion for well tested, clearly structured
                            code and I also have a love for teaching other engineers and
                            building them custom tools to enhance their workflows, along with
                            promoting good documentation and craftsmanship practices even when
                            deadlines are tight.
                        </p>
                        <p className="text-lg mb-8">
